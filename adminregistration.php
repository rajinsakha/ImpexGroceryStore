...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if ($numExistRows > 0) {
    ...
    if (($password == $cpassword)) {
      ...
      $sql = "INSERT INTO `admins`( `fullname`, `email`, `password`, `mobile_num`, `created_at`) VALUES ('$fullname','$email','$hash','$contact',current_timestamp())";
...
<head>
  ...
  <title>Admin SignUp | Impex Grocery Store</title>
